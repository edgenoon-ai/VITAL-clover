import cv2
import numpy as np
# https://github.com/Megvii-BaseDetection/YOLOX/blob/dd5700c24693e1852b55ce0cb170342c19943d8b/yolox/utils/visualize.py#L11
...
def visualize(img, boxes, scores, cls_ids, conf=0.5, class_names=None):
    ...
    for i in range(len(boxes)):
        ...
        text = '{}:{:.1f}%'.format(class_names[cls_id] if class_names is not None else cls_id, score * 100)
